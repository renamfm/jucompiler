...
class Teste {
  public static int main(String[] args){
    if (Miguel+Paulo==juntos_nos_projetos_todos) {
      System.out.printf("20 no projeto de SD");
      System.out.printf("20 no projeto de PPP");
      System.out.printf("20 no projeto de POO");
      System.out.printf("20 no projeto de TI");
      System.out.printf("20 no projeto de MULTIMEDIA");
      System.out.printf("20 no projeto de IRC");
        if (cadeira==SCC) {
          if(0){if(0){if(0){if(0){if(0){if(0){if(0){if(0){if(0){
            System.out.printf("Plagio mas depois 15");
          }}}}}}}}}

        }
    }
    soQuero800NestaMeta((((1__3))),miguel,soQuero800NestaMeta(1+1));
    System.out.printf(Paulo = Gostoso);
