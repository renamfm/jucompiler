...
{
       0,    66,    66,    73,    75,    84,    93,   101,   108,   125,
     130,   131,   140,   141,   142,   145,   152,   159,   165,   173,
...
#line 108 "jucompiler.y" /* yacc.c:1646  */
    {   
                                                            ...
                                                            while((yyvsp[-1].ast)!=NULL){
                                                                ...
                                                                add_brother(aux2, create_node((yyvsp[-1].ast)->nome, (yyvsp[-1].ast)->valor, (yyvsp[-1].ast)->linha, (yyvsp[-1].ast)->coluna));
                                                                add_son(aux, aux2);
...
#line 159 "jucompiler.y" /* yacc.c:1646  */
    {
                                                        (yyval.ast) = create_node("MethodHeader","", linha, coluna);
                                                        add_son((yyval.ast), create_node("Void","", (yyvsp[-4].id)->line, (yyvsp[-4].id)->col));
...
#line 165 "jucompiler.y" /* yacc.c:1646  */
    {
                                                        (yyval.ast) = create_node("MethodHeader","", linha, coluna);
                                                        add_son((yyval.ast), create_node("Void","", (yyvsp[-3].id)->line, (yyvsp[-3].id)->col));
...
#line 173 "jucompiler.y" /* yacc.c:1646  */
    {
                                        ...
                                        while((yyvsp[0].ast)!=NULL){
                                            ...
                                            add_brother(aux->filho, create_node((yyvsp[0].ast)->irmao->nome, (yyvsp[0].ast)->irmao->valor, (yyvsp[0].ast)->irmao->linha, (yyvsp[0].ast)->irmao->coluna));
...
#line 231 "jucompiler.y" /* yacc.c:1646  */
    { 
                                            ...
                                            while((yyvsp[-1].ast)!=NULL){
                                                ...
                                                add_brother(aux->filho, create_node((yyvsp[-1].ast)->nome, (yyvsp[-1].ast)->valor, (yyvsp[-1].ast)->linha, (yyvsp[-1].ast)->coluna));
                                                add_brother((yyval.ast), aux);
                                                (yyvsp[-1].ast) = (yyvsp[-1].ast)->irmao;
                                            }
                                        }
...
#line 284 "jucompiler.y" /* yacc.c:1646  */
    {
                                                        (yyval.ast) = create_node("Return", "", (yyvsp[-2].id)->line, (yyvsp[-2].id)->col);
                                                        add_son((yyval.ast), (yyvsp[-1].ast));
                                                    }
...
#line 288 "jucompiler.y" /* yacc.c:1646  */
    {   
                                                        (yyval.ast) = create_node("Return", "", (yyvsp[-1].id)->line, (yyvsp[-1].id)->col);
                                                    }
...
#line 356 "jucompiler.y" /* yacc.c:1646  */
    {
                                                    (yyval.ast) = create_node("ParseArgs", "", (yyvsp[-6].id)->line, (yyvsp[-6].id)->col);
                                                    add_son((yyval.ast), create_identifier_node("Id", (yyvsp[-4].id)));
                                                    add_brother((yyval.ast)->filho, (yyvsp[-2].ast));    
                                                }
...
#line 454 "jucompiler.y" /* yacc.c:1646  */
    {
                                                            (yyval.ast) = create_node("Not","", (yyvsp[-1].id)->line, (yyvsp[-1].id)->col);
							                                add_son((yyval.ast),(yyvsp[0].ast));
                                                        }
