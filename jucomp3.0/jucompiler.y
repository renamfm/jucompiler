...
FieldDecl: PUBLIC STATIC Type ID CommaID SEMICOLON      {   
                                                            ...
                                                            while($5!=NULL){
                                                                ...
                                                                add_brother(aux2, create_node($5->nome, $5->valor, linha, coluna));
                                                                add_son(aux, aux2);
                                                                add_brother($$, aux);
                                                                $5=$5->irmao;
                                                            }
...
MethodHeader: Type ID LPAR FormalParams RPAR        { 
    ...
    | VOID ID LPAR FormalParams RPAR                {
                                                        $$ = create_node("MethodHeader","", linha, coluna);
                                                        add_son($$, create_node("Void","", linha, coluna));
...
FormalParams:Type ID CommaTypeID           {
                                    ...
                                    while($3!=NULL){
                                            ...
                                            add_brother(aux->filho, create_node($3->irmao->nome, $3->irmao->valor, linha, coluna));
...
VarDecl: Type ID CommaID SEMICOLON      { 
                                            ...
                                            while($3!=NULL){
                                                ...
                                                add_brother(aux->filho, create_node($3->nome, $3->valor, linha, coluna));
                                                add_brother($$, aux);
                                                $3 = $3->irmao;
                                            }
                                        }
...
Statement: LBRACE Statements RBRACE                 {   
    ...
    | RETURN Expr SEMICOLON                         {
                                                        $$ = create_node("Return", "", linha, coluna);
                                                        add_son($$, $2);
                                                    }
    | RETURN SEMICOLON                              {   
                                                        $$ = create_node("Return", "", linha, coluna);
...
ParseArgs: PARSEINT LPAR ID LSQ Expr RSQ RPAR   {
                                                    $$ = create_node("ParseArgs", "", linha, coluna);
